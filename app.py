...
def create_app():
    ...
    # CSRF fixes for Render/proxy deployment
    ...
    # Safer CSP for Flask + Render + templates
    Talisman(
        app,
        ...
        if form.validate_on_submit():
            ...
            try:
                msg = Message(
                    ...
                    recipients=["thresholdtechnologylimited@gmail.com"],
                )
                msg.body = f"""
...
Company / Project: {form.company.data or "N/A"}
